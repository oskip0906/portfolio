...
const AudioPlayer: React.FC = () => {
    ...
    return (
        <motion.div
            className="text-center mt-4 bg-gray-900 p-4 rounded-lg"
        ...
        >
            ...
            {isShowing && (
                <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                >
                    <button onClick={togglePlayPause} className="btn btn-primary rounded mr-5 py-2 px-4 text-sm" style={{ boxShadow: '0 0 10px rgba(28, 69, 181, 0.9)' }}>Play/Pause</button>
